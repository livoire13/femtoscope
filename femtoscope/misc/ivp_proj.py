# -*- coding: utf-8 -*-
"""
Created on Fri Jul 14 19:19:21 2023
Modification of scipy `solve_ivp` routine to enable the projection of the
current state onto some constraint manifold using the oblique projection
technique.

THIS IS ONLY AN ATTEMPT AT THE MOMENT, NOT A WORKING PIECE OF CODE!
